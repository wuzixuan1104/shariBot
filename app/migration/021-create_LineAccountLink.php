...
return [
  'up' => "CREATE TABLE `LineAccountLink` (
    ...
    `result`       varchar(50)  COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '結果',
    `nonce`        text COLLATE utf8mb4_unicode_ci COMMENT '內容',
    `updateAt`     datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新時間',
    `createAt`     datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增時間',
    PRIMARY KEY (`id`)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;",

  'down' => "DROP TABLE `LineAccountLink`;",

  'at' => "2019-03-18 13:49:39"
];
